...
from dataset.decimind_dataset import CountdownTasksDataset, NewCountdownTasksDataset
from GRPO.grpo import rollout, update_policy
from GRPO.optimizer import MemoryEfficientAdamW
from GRPO.reward_module import reward_function
...
def main(config_path: str):
    ...
    train_dataset = NewCountdownTasksDataset(
        data_path=config["data"]["path"],
        tokenizer=tokenizer,
        split="train",
        test_size=config["data"]["test_size"],
    ...
    train_dataloader = DataLoader(
        train_dataset,
        shuffle=True,
        collate_fn=NewCountdownTasksDataset.collate_fn,
        generator=generator,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="/root/MiniQA/config/config_24GB.yaml")
